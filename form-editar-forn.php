    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Editar Fornecedor</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Account Menu -->
                    <?php
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 mt-8">
                            ...
                            if(isset($_GET['id'])){
                                $fornid = $_GET['id'];
                                $query = "SELECT * FROM fornecedores WHERE idforn = '$fornid'";
                            ...
                            ?>
                            <form action="form-editar-forn.php" method="post">
                                <div class="intro-y box">
                                    <div class="p-5" id="input">
                                        <div class="preview">
                                            <div>
                                                <input name = "fornid" value="<?php echo $fornid?>" hidden>
                                            </div>
                                            <div>
                                                <label>Nome</label>
                                            ...
                                            <div>
                                                <label>Email</label>
                                                <input name="email" value="<?php echo $row["email"]?>" type="email" class="input w-full border mt-1 mb-4" placeholder="Email">
                                            </div>
                                            <div>
                            ...
                            <?php } ?>                                                                        
                            <?php
                                if(isset($_POST["fornid"]) && isset($_POST["nome"]) && isset($_POST["email"]) && isset($_POST["telefone"]) && isset($_POST["localidade"])){
                                    $ffornid = $_POST["fornid"];
                                    $fnome = $_POST["nome"];
                                    $femail = $_POST["email"];
                                    $ftelefone = $_POST["telefone"];
                                    $flocalidade = $_POST["localidade"];

                                    $query = mysqli_query($link, "UPDATE fornecedores SET nome = '$fnome', email = '$femail', telefone = '$ftelefone', localidade = '$flocalidade' WHERE idforn = '$ffornid'");
                                    if($query){
                                        echo "<div class=\"rounded-md px-5 py-4 mb-2 bg-theme-9 text-white\">Editado com sucesso</div>";

                                        $query = mysqli_query($link, "INSERT INTO logs (user, descricao, datahora, userid) VALUES ('$user_name', 'Editou Fornecedor', now(), '$iduser')");
                                        ?>
                                            <script>
