    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Remover Utilizador</a> </div>
                    <!-- END: Breadcrumb -->
                        ...
                        <div class="col-span-12 mt-8">
                            <div class="intro-y flex items-center h-10">
                                ...
                                <!-- <a href="" class="ml-auto flex text-theme-1 dark:text-theme-10"> <i data-feather="refresh-ccw" class="w-4 h-4 mr-3"></i> Reload Data </a> -->
                                    ...
                                    <form action="removerutilizador.php" name="apagar_user" id="apagar_user" method="post">                                   
                                        Escolha o utilizador que pretende remover:
                                        <div class="mt-2">
                                            <select name="userid" class="input border mr-2">
                                                <?php
                                                    $qry = "Select * from utilizadores where id !=0 order by id";
                                    ...
                                    <?php
                                        if(isset($_POST["userid"]))
                                        {
                                            ...
                                            $query = mysqli_query($link, "update utilizadores set estado = 0 where id = '$fuserid'");
