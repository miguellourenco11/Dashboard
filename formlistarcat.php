    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Listar categorias</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Account Menu -->
                    <?php
                    ...
                    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 mt-8">
                            ...
                            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                                <form method="POST" action="exportar-cat.php">
                                ...
                                <table class="table table-report -mt-2">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = "SELECT * FROM categorias where estado = 1 order by id";
                                            ...
                                            echo "</div></div></td>";
                                            echo "<td class=\"font-medium whitespace-no-wrap\">" . $row['nomecat'] . "</td>";

                                            // Ações
                                            if($idtipo == 1){
                                            echo '<td class="table-report__action w-56">';
                                            echo '<div class="flex justify-center items-center">';
                                            echo '<a class="flex items-center mr-3" href="form-editar-cat.php?id='.$row['id'].'"><i data-feather="check-square" class="w-4 h-4 mr-1"></i> Editar </a>';
                                            echo '<a class="flex items-center text-theme-6 delete-cat" href="javascript:;" data-toggle="modal" data-target="#delete-confirmation-modal" data-id="'.$row['id'].'"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Apagar </a>';
                                            echo '</div>';
                                            echo '</td>';
                                            }
                                            echo '</tr>';
                        ...
                        <?php 
                            if(isset($_POST['del_cat_id'])){
                                ...
                                if(isset($id)){
                                    ...
                                    $query = mysqli_query($link, "INSERT INTO logs (user, descricao, datahora, userid) VALUES ('$user_name', 'Removeu Categoria', now(), '$iduser')");
                                    ?>
                                    <script>
