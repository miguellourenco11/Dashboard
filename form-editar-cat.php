    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Editar Categoria</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Account Menu -->
                    <?php
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 mt-8">
                            ...
                            if(isset($_GET['id'])){
                                $catid = $_GET['id'];
                                $query = "SELECT * FROM categorias WHERE id = '$catid'";
                            ...
                            ?>
                            <form action="form-editar-cat.php" method="post">
                                <div class="intro-y box">
                                    ...
                                    <div class="p-5" id="input">
                                        <div class="preview">
                                            <div>
                                                <input name = "catid" value="<?php echo $catid?>" hidden>
                                            </div>
                                            <div>
                                                <label>Nome</label>
                                                <input name="nomecat" value="<?php echo $row["nomecat"] ?>" type="text" class="input w-full border mt-1 mb-4">
                                            </div>
                                        </div>
                            ...
                            <?php } ?>                                                                        
                            <?php
                                if(isset($_POST["catid"]) && isset($_POST["nomecat"])){
                                    $fcatid = $_POST["catid"];
                                    $fnomecat = $_POST["nomecat"];

                                    $query = mysqli_query($link, "UPDATE categorias SET nomecat = '$fnomecat' WHERE id = '$fcatid'");
                                    if($query){
                                        echo "<div class=\"rounded-md px-5 py-4 mb-2 bg-theme-9 text-white\">Editada com sucesso</div>";

                                        $query = mysqli_query($link, "INSERT INTO logs (user, descricao, datahora, userid) VALUES ('$user_name', 'Editou Categoria', now(), '$iduser')");
                                        ?>
                                            <script>
