    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Remover Fornecedor</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Account Menu -->
                        ...
                        <div class="col-span-12 mt-8">
                            <div class="intro-y flex items-center h-10">
                                ...
                                <!-- <a href="" class="ml-auto flex text-theme-1 dark:text-theme-10"> <i data-feather="refresh-ccw" class="w-4 h-4 mr-3"></i> Reload Data </a> -->
                                    ...
                                    <form action="removerfornecedor.php" name="apagar_prod" id="apagar_prod" method="post">                                   
                                        Escolha o Fornecedor que pretende remover:
                                        <div class="mt-2">
                                            <select name="fornid" class="input border mr-2">
                                                <?php
                                                    $qry = "Select * from fornecedores order by idforn";
                                    ...
                                    <?php
                                        if(isset($_POST["fornid"]))
                                        {
                                            $fornid = $_POST["fornid"];
                                            $query = mysqli_query($link, "update fornecedores set estado = 0 where idforn = '$fornid'");
