    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Inserir Categoria</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Account Menu -->
                    <?php
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                        ...
                        <form action="forminserircat.php" method="post" enctype="multipart/form-data">
                            <div class="intro-y box">
                                <div class="p-5" id="input">
                                    ...
                                    <div class="preview">
                                        <div>
                                            <label>Nome</label>
                                            <input name="nomecat" type="text" class="input w-full border mt-1 mb-4" placeholder="Nome">
                                        </div>
                                    </div>
                        ...
                        // Ligação Base de Dados
                            ...
                            if(isset($_POST["nomecat"])){
                                ...
                                $query = mysqli_query($link, "INSERT into categorias(nomecat, datahora, estado, name, type, size, content) values('$fnomecat', now(), 1, '$file_name', '$file_type', '$file_size', '$content');");
                                if($query){
                                    echo "<div class=\"rounded-md px-5 py-4 mb-2 bg-theme-9 text-white\">Inserida com sucesso</div>";

                                    $query = mysqli_query($link, "INSERT INTO logs (user, descricao, datahora, userid) VALUES ('$user_name', 'Inseriu Categoria', now(), '$iduser')");
                                }
                                else
                                {
