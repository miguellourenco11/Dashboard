    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Inserir Empresa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Account Menu -->
                    <?php 
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                        ...
                        <form action="forminseriremp.php" method="post">
                            <div class="intro-y box">
                                <div class="p-5" id="input">
                                    <div class="preview">
                                        ...
                                        <div>
                                            <label>Site</label>
                                            <input name="site" type="text" class="input w-full border mt-1 mb-4" placeholder="Site">
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input name="observacoes" type="text" class="input w-full border mt-1 mb-4" placeholder="Observações">
                                        </div>
                                    </div>
                        ...
                        <?php
                            if(isset($_POST["nome"]) && isset($_POST["telefone"]) && isset($_POST["email"]) && isset($_POST["site"]) && isset($_POST["localidade"]) && isset($_POST["observacoes"])){
                                ...
                                $query = mysqli_query($link, "insert into empresas(nome, telefone, email, site, localidade, observacoes, datahora, estado) values('$fnome', '$ftelefone', '$femail', '$fsite', '$flocalidade', '$fobservacoes', now(), 1);");
                                if($query){
                                    echo "<div class=\"rounded-md px-5 py-4 mb-2 bg-theme-9 text-white\">Inserida com sucesso</div>";

                                    $query = mysqli_query($link, "INSERT INTO logs (user, descricao, datahora, userid) VALUES ('$user_name', 'Inseriu Empresa', now(), '$iduser')");
                                }
                                else
                                {
