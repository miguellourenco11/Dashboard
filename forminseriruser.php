    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Inserir Utilizador</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Account Menu -->
                    <?php 
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                        ...
                        <form action="forminseriruser.php" method="POST" enctype="multipart/form-data">
                            <div class="intro-y box">
                                <div class="p-5" id="input">
                                    ...
                                    <div class="preview">
                                        <div>
                                            <label>Nome</label>
                                            <input name="user" type="text" class="input w-full border mt-1 mb-4" placeholder="Nome">
                                        </div>
                                        <div>
                                            <label>Tipo</label>
						...
						<?php
							...
							if(isset($_POST['user']) && isset($_POST['upload']) && isset($_POST['idtipo'])){
								$fuser = $_POST['user'];
								...
								$query = mysqli_query($link,"INSERT INTO utilizadores (user, pass, datahora, estado, name, type, size, content, idtipo) VALUES ('$fuser', '$fpass2', now(), 1, '$file_name', '$file_type', '$file_size', '$content', '$fidtipo')");	

                                if($query){
									echo "<div class=\"rounded-md px-5 py-4 mb-2 bg-theme-9 text-white\">Inserido com sucesso. A password é: ".$fpass."</div>";

                                    $query = mysqli_query($link, "INSERT INTO logs (user, descricao, datahora, userid) VALUES ('$user_name', 'Inseriu Utilizador', now(), '$iduser')");
