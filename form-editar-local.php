    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Editar Localidade</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Account Menu -->
                    <?php
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 mt-8">
                            ...
                            if(isset($_GET['id'])){
                                $localid = $_GET['id'];
                                $query = "SELECT * FROM localidades WHERE id = '$localid'";
                            ...
                            ?>
                            <form action="form-editar-local.php" method="post">
                                <div class="intro-y box">
                                    ...
                                    <div class="p-5" id="input">
                                        <div class="preview">
                                            <div>
                                                <input name = "localid" value="<?php echo $localid?>" hidden>
                                            </div>
                                            <div>
                                                <label>Nome</label>
                                                <input name="nome" value="<?php echo $row["nome"] ?>" type="text" class="input w-full border mt-1 mb-4">
                                            </div>
                                        </div>
                            ...
                            <?php } ?>                                                                        
                            <?php
                                if(isset($_POST["localid"]) && isset($_POST["nome"])){
                                    $flocalid = $_POST["localid"];
                                    $fnome = $_POST["nome"];

                                    $query = mysqli_query($link, "UPDATE localidades SET nome = '$fnome' WHERE id = '$flocalid'");
                                    if($query){
                                        echo "<div class=\"rounded-md px-5 py-4 mb-2 bg-theme-9 text-white\">Editada com sucesso</div>";

                                        $query = mysqli_query($link, "INSERT INTO logs (user, descricao, datahora, userid) VALUES ('$user_name', 'Editou Localidade', now(), '$iduser')");
                                        ?>
                                            <script>
