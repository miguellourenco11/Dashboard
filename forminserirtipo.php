    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Inserir Tipo</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Account Menu -->
                    <?php 
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                        ...
                        <form action="forminserirtipo.php" method="post">
                        ...
                        <?php
                            if(isset($_POST["nome"])){
                                ...
                                $query = mysqli_query($link, "insert into tipo_user(tipo, estado, datahora) values('$fnome', 1, now());");
                                if($query){
                                    echo "<div class=\"rounded-md px-5 py-4 mb-2 bg-theme-9 text-white\">Inserido com sucesso</div>";

                                    $query = mysqli_query($link, "INSERT INTO logs (user, descricao, datahora, userid) VALUES ('$user_name', 'Inseriu Tipo de Utilizador', now(), '$iduser')");
                                }
                                else
                                {
