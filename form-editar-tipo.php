    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Editar Tipo</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Account Menu -->
                    <?php
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12 mt-8">
                            ...
                            if(isset($_GET['id'])){
                                $tipoid = $_GET['id'];
                                $query = "SELECT * FROM tipo_user WHERE idtipo = '$tipoid'";
                            ...
                            ?>
                            <form action="form-editar-tipo.php" method="post">
                                <div class="intro-y box">
                                    <div class="p-5" id="input">
                                        <div class="preview">
                                            <div>
                                                <input name = "fornid" value="<?php echo $tipoid?>" hidden>
                                            </div>
                                            <div>
                                                <label>Nome</label>
                            ...
                            <?php } ?>                                                                        
                            <?php
                                if(isset($_POST["tipoid"]) && isset($_POST["nome"])){
                                    $ftipoid = $_POST["tipoid"];
                                    $fnome = $_POST["nome"];

                                    $query = mysqli_query($link, "UPDATE tipo_user SET tipo = '$fnome' WHERE idforn = '$ffornid'");
                                    if($query){
                                        echo "<div class=\"rounded-md px-5 py-4 mb-2 bg-theme-9 text-white\">Editado com sucesso</div>";

                                        $query = mysqli_query($link, "INSERT INTO logs (user, descricao, datahora, userid) VALUES ('$user_name', 'Editou Tipo de Utilizador', now(), '$iduser')");
                                        ?>
                                            <script>
