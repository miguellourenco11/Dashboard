    ...
    <body class="app">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Menu</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Remover Produto</a> </div>
                    <!-- END: Breadcrumb -->
                        ...
                        <div class="col-span-12 mt-8">
                            <div class="intro-y flex items-center h-10">
                                ...
                                <!-- <a href="" class="ml-auto flex text-theme-1 dark:text-theme-10"> <i data-feather="refresh-ccw" class="w-4 h-4 mr-3"></i> Reload Data </a> -->
                                    ...
                                    <form action="removerproduto.php" name="apagar_prod" id="apagar_prod" method="post">                                   
                                        Escolha o produto que pretende remover:
                                        <div class="mt-2">
                                            <select name="prodid" class="input border mr-2">
                                                <?php
                                                    $qry = "Select * from produto where estado = 1 order by codprod";
                                                    $result = mysqli_query($link, $qry);
                                                    while ($row = mysqli_fetch_array($result)) {
                                                    ?>
                                                        <option value = "<?php echo $row['codprod'];?>">
                                    ...
                                    <?php
                                        if(isset($_POST["prodid"]))
                                        {
                                            ...
                                            $query = mysqli_query($link, "update produto set estado = 0 where codprod = '$fprodid'");
